object PigLatin {
    ...
    fun translate(phrase: String): String {
        ...
        for ((index, word) in words.withIndex()) {
            val ruleOneWord = ruleOne(word)
            val ruleTwoWord = ruleTwo(word)
            val ruleThreeWord = ruleThree(word)
            val ruleFourWord = ruleFour(word)
            var newWord = ""

            when {
                ruleOneWord != word -> newWord = ruleOneWord
                ruleFourWord != word -> newWord = ruleFourWord
                ruleThreeWord != word -> newWord = ruleThreeWord
                ruleTwoWord != word -> newWord = ruleTwoWord
            }
